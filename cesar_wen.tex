...
\newcommand{\cvCertificate}[2]{{\firaMedium #1} \\ {\color{link_blue}\textsc{\selectfont #2}}\\ \smallskip \emph{#2}}
...
\begin{document}
	...
	{\cvExperience%
		...
		{Software de aquisição e armazenamento de dados de estações meteorológicas para a análise de conforto ambiental.}};
	\node[
	left=\cvTimeDotSep of item 2 header,
	timedot]   
	{};
