...
\begin{document}
	...
	column 6/.style={anchor=west}] (skills) {
		\cvSkill{4} & MATLAB\hspace{0.5cm}   & \cvSkill{3} & C, C+                 & \cvSkill{4} & mySQL\\
		\cvSkill{4} & Python                 & \cvSkill{3} & Java\hspace{0.5cm}    & \cvSkill{2} & \LaTeX\\
		\cvSkill{3} & git                    & \cvSkill{2} & HTML, CSS             & & \\};	
	...
	column 4/.style={anchor=west},] (skills) {
		...
		\cvSkill{3} & Autodesk Inventor\hspace{0.5cm}     & \cvSkill{2} & Pacote Office\\
		\cvSkill{2} & Diptrace                            & & \\};
