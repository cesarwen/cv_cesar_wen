...
\begin{document}
	...
	\begin{minipage}{\cvSideWidth}
		\begin{center}
			...
			Entusiasta por tecnologia, gosto de aprender e implementar novas tecnologias e ideias. \\Duas frases as quais acredito que me descrevem são: "Só sei que nada sei" de Sócrates, não que eu realmente não saiba nada, mas acredito que sempre há o que aprender, com qualquer coisa, situação e pessoa. A outra é "Só existem dois jeitos de fazer qualquer coisa, direito ou novamente" cujo autor desconheço, ou seja, tudo que se faz deve ser feito direito ou devem ser encontradas outras formas de serem realizadas para que o resultado seja excelente. 
			...
			row sep=5pt] (contact) {
				...
				& \node{+81 80 2185-8005};\\
				\node{\faGlobe}; 
				& \node{\href{https://cesarwen.github.io/profile/}{cesarwen/profile/}};\\
				\node{\faGithub}; 
				& \node{\href{https://github.com/cesarwen}{cesarwen}};\\
				\node{\faLinkedinSquare}; 
				& \node{\href{https://www.linkedin.com/in/cesarwen/}{cesarwen}};\\
			};
			\end{tikzpicture}
	...
	{\cvEducation{Intercâmbio}%
		...
		{Programa "Sandwich Program" oferecido pela faculdade no exterior em parceria com a Escola Politécnica. Estudos sobre a cultura, linguas e tecnologia.}};
	\node[
	...
	column 6/.style={anchor=west}] (skills) {
		\cvSkill{4} & MATLAB\hspace{0.5cm}   & \cvSkill{3} & C, C+                 & \cvSkill{4} & SQL\\
		\cvSkill{4} & Python                 & \cvSkill{3} & Java\hspace{0.5cm}    & \cvSkill{2} & \LaTeX\\
		\cvSkill{3} & git                    & \cvSkill{3} & HTML, CSS, JS         & \cvSkill{4} & Excel\\};	
	...
	\node[left=\cvTimeDotSep of title 5,headerIcon] {\faCogs};
	...
	{\cvExperience%
		...
		{04 de Agosto 2020 -- 08 de Agosto 2020}%
	...
	{\cvExperience%
		...
		{Plataforma Alura}%
		{Formação Excel VBA}%
		{10 de Julho 2020 -- 08 de Agosto 2020}%
